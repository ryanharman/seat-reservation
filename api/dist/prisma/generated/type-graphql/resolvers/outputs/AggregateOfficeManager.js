...
exports.AggregateOfficeManager = void 0;
...
let AggregateOfficeManager = class AggregateOfficeManager {
};
__decorate([
...
], AggregateOfficeManager.prototype, "_count", void 0);
__decorate([
    TypeGraphQL.Field(_type => OfficeManagerAvgAggregate_1.OfficeManagerAvgAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateOfficeManager.prototype, "_avg", void 0);
__decorate([
    TypeGraphQL.Field(_type => OfficeManagerSumAggregate_1.OfficeManagerSumAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateOfficeManager.prototype, "_sum", void 0);
__decorate([
    TypeGraphQL.Field(_type => OfficeManagerMinAggregate_1.OfficeManagerMinAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateOfficeManager.prototype, "_min", void 0);
__decorate([
    TypeGraphQL.Field(_type => OfficeManagerMaxAggregate_1.OfficeManagerMaxAggregate, {
        nullable: true
    }),
    __metadata("design:type", Object)
], AggregateOfficeManager.prototype, "_max", void 0);
AggregateOfficeManager = __decorate([
    TypeGraphQL.ObjectType({
        isAbstract: true
    })
], AggregateOfficeManager);
exports.AggregateOfficeManager = AggregateOfficeManager;
//# sourceMappingURL=AggregateOfficeManager.js.map