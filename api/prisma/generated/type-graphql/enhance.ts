...
const relationResolversInfo = {
  User: ["reservations"],
  Reservation: ["user", "office", "bookedItem"],
  Office: ["building", "reservations", "bookableItems", "officeManagers"],
...
const modelsInfo = {
  ...
  Reservation: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  Office: ["id", "buildingId", "createdAt", "updatedAt"],
  OfficeManager: ["id", "officeId", "name", "createdAt", "updatedAt"],
  BookableItem: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
...
const inputsInfo = {
  ...
  ReservationWhereInput: ["AND", "OR", "NOT", "id", "user", "userId", "office", "officeId", "bookedItem", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ReservationOrderByInput: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ReservationWhereUniqueInput: ["id"],
  ReservationScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  OfficeWhereInput: ["AND", "OR", "NOT", "id", "building", "buildingId", "createdAt", "updatedAt", "reservations", "bookableItems", "officeManagers"],
  ...
  BookableItemWhereInput: ["AND", "OR", "NOT", "id", "office", "officeId", "type", "typeId", "name", "available", "createdAt", "updatedAt", "reservations"],
  BookableItemOrderByInput: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
  BookableItemWhereUniqueInput: ["id"],
  BookableItemScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
  BookableItemTypesWhereInput: ["AND", "OR", "NOT", "id", "name", "bookableItems", "createdAt", "updatedAt"],
  ...
  ReservationCreateInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "user", "office", "bookedItem"],
  ReservationUpdateInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "user", "office", "bookedItem"],
  ReservationCreateManyInput: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ReservationUpdateManyMutationInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  OfficeCreateInput: ["createdAt", "updatedAt", "building", "reservations", "bookableItems", "officeManagers"],
  OfficeUpdateInput: ["createdAt", "updatedAt", "building", "reservations", "bookableItems", "officeManagers"],
  ...
  BookableItemCreateInput: ["name", "available", "createdAt", "updatedAt", "office", "type", "reservations"],
  BookableItemUpdateInput: ["name", "available", "createdAt", "updatedAt", "office", "type", "reservations"],
  BookableItemCreateManyInput: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
  BookableItemUpdateManyMutationInput: ["name", "available", "createdAt", "updatedAt"],
  ...
  OfficeCreateNestedOneWithoutReservationsInput: ["create", "connectOrCreate", "connect"],
  ...
  OfficeUpdateOneRequiredWithoutReservationsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  ReservationCreateNestedManyWithoutOfficeInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ReservationUpdateManyWithoutOfficeInput: ["create", "connectOrCreate", "upsert", "createMany", "connect", "set", "disconnect", "delete", "update", "updateMany", "deleteMany"],
  ...
  ReservationCreateWithoutUserInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "office", "bookedItem"],
  ...
  ReservationScalarWhereInput: ["AND", "OR", "NOT", "id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ...
  OfficeCreateWithoutReservationsInput: ["createdAt", "updatedAt", "building", "bookableItems", "officeManagers"],
  OfficeCreateOrConnectWithoutReservationsInput: ["where", "create"],
  BookableItemCreateWithoutReservationsInput: ["name", "available", "createdAt", "updatedAt", "office", "type"],
  ...
  OfficeUpsertWithoutReservationsInput: ["update", "create"],
  OfficeUpdateWithoutReservationsInput: ["createdAt", "updatedAt", "building", "bookableItems", "officeManagers"],
  BookableItemUpsertWithoutReservationsInput: ["update", "create"],
  BookableItemUpdateWithoutReservationsInput: ["name", "available", "createdAt", "updatedAt", "office", "type"],
  ...
  ReservationCreateWithoutOfficeInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "user", "bookedItem"],
  ReservationCreateOrConnectWithoutOfficeInput: ["where", "create"],
  ReservationCreateManyOfficeInputEnvelope: ["data", "skipDuplicates"],
  BookableItemCreateWithoutOfficeInput: ["name", "available", "createdAt", "updatedAt", "type", "reservations"],
  ...
  ReservationUpsertWithWhereUniqueWithoutOfficeInput: ["where", "update", "create"],
  ReservationUpdateWithWhereUniqueWithoutOfficeInput: ["where", "data"],
  ReservationUpdateManyWithWhereWithoutOfficeInput: ["where", "data"],
  ...
  BookableItemScalarWhereInput: ["AND", "OR", "NOT", "id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
  ...
  OfficeCreateWithoutOfficeManagersInput: ["createdAt", "updatedAt", "building", "reservations", "bookableItems"],
  OfficeCreateOrConnectWithoutOfficeManagersInput: ["where", "create"],
  OfficeUpsertWithoutOfficeManagersInput: ["update", "create"],
  OfficeUpdateWithoutOfficeManagersInput: ["createdAt", "updatedAt", "building", "reservations", "bookableItems"],
  OfficeCreateWithoutBookableItemsInput: ["createdAt", "updatedAt", "building", "reservations", "officeManagers"],
  ...
  ReservationCreateWithoutBookedItemInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "user", "office"],
  ...
  OfficeUpdateWithoutBookableItemsInput: ["createdAt", "updatedAt", "building", "reservations", "officeManagers"],
  ...
  BookableItemCreateWithoutTypeInput: ["name", "available", "createdAt", "updatedAt", "office", "reservations"],
  ...
  OfficeCreateWithoutBuildingInput: ["createdAt", "updatedAt", "reservations", "bookableItems", "officeManagers"],
  ...
  ReservationCreateManyUserInput: ["id", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ReservationUpdateWithoutUserInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "office", "bookedItem"],
  ReservationCreateManyOfficeInput: ["id", "userId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  BookableItemCreateManyOfficeInput: ["id", "typeId", "name", "available", "createdAt", "updatedAt"],
  OfficeManagerCreateManyOfficeInput: ["id", "name", "createdAt", "updatedAt"],
  ReservationUpdateWithoutOfficeInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "user", "bookedItem"],
  BookableItemUpdateWithoutOfficeInput: ["name", "available", "createdAt", "updatedAt", "type", "reservations"],
  OfficeManagerUpdateWithoutOfficeInput: ["name", "createdAt", "updatedAt"],
  ReservationCreateManyBookedItemInput: ["id", "userId", "officeId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ReservationUpdateWithoutBookedItemInput: ["dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "user", "office"],
  BookableItemCreateManyTypeInput: ["id", "officeId", "name", "available", "createdAt", "updatedAt"],
  BookableItemUpdateWithoutTypeInput: ["name", "available", "createdAt", "updatedAt", "office", "reservations"],
  OfficeCreateManyBuildingInput: ["id", "createdAt", "updatedAt"],
  BuildingManagerCreateManyBuildingInput: ["id", "name", "createdAt", "updatedAt"],
  OfficeUpdateWithoutBuildingInput: ["createdAt", "updatedAt", "reservations", "bookableItems", "officeManagers"],
...
const outputsInfo = {
  ...
  ReservationGroupBy: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  BookableItemGroupBy: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  ReservationCountAggregate: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt", "_all"],
  ReservationAvgAggregate: ["id", "userId", "officeId", "bookedItemId"],
  ReservationSumAggregate: ["id", "userId", "officeId", "bookedItemId"],
  ReservationMinAggregate: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ReservationMaxAggregate: ["id", "userId", "officeId", "bookedItemId", "dateBookedFrom", "dateBookedTo", "cancelled", "password", "role", "createdAt", "updatedAt"],
  ...
  BookableItemCountAggregate: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt", "_all"],
  BookableItemAvgAggregate: ["id", "officeId", "typeId"],
  BookableItemSumAggregate: ["id", "officeId", "typeId"],
  BookableItemMinAggregate: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
  BookableItemMaxAggregate: ["id", "officeId", "typeId", "name", "available", "createdAt", "updatedAt"],
